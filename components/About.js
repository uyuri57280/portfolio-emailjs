      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mt-7">
          <p className="mt-6 text-gray-600 text-lg md:text-xl leading-9">
            ...
            <br />
            フロントエンド開発では、ユーザビリティとユーザーエクスペリエンスに焦点を当
            て、モダンなフロントエンドフレームワークを使用して使いやすく美しいウェブア
            プリケーションを構築します。モバイルフレンドリーなデザインやリアルタイム対
            応など、モダンなウェブアプリケーションの要件を満たします。
            <br />
            また、コンテナ化、デプロイメント、CI/CDパイプラインの設計と実装にも熟練し
            ており、クラウドプラットフォームでのアプリケーションの運用にも精通していま
            す。
          </p>
        </div>
        {/* 軽い実績 */}
